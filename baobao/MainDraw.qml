...
Rectangle {
    ...
    property alias gridX: gridRootRect.x
    property real gridBahX: root.width/2 - gridRootRect.width/2
    property real gridWidth: 50*5+10*4+10
    ...
    Rectangle{
        ...
        Grid{
            ...
            Repeater{
                function randomModel(){
                    model = randomJackpot(jackpotName)
                }
